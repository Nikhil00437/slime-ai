import { TensuraSkill, SkillRank, CompatibilityResult, RANK_GENERATION_RATES } from './types';
...
Task: Create an AI assistant skill for the Tensura universe.
...
): Promise<Omit<TensuraSkill, 'id' | 'createdAt'>> {
...
export function computeCompatibility(a: TensuraSkill, b: TensuraSkill): CompatibilityResult {
